const C="dezhou-ranking-chips-v80";
const ASSETS=["./","./index.html","./styles.css?v=80","./app.js?v=80","./poker-judge.js?v=v35","./manifest.webmanifest?v=30","./assets/rank-1.png","./assets/rank-2.png","./assets/rank-3.png"];
