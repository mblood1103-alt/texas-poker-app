...
}$("differenceHint").textContent=diff===0?"<span style="color:#16a34a;font-weight:700;">帳目相符，可以安心結算。</span>":"⚠️ 帳目不符，請檢查後再結算。";$("differenceHint").classList.toggle("is-mismatch",diff!==0);
