...
function rankBadge(rank){
  ...
  if(n>=1&&n<=3)return `<span class="rank-chip rank-chip-top"><img src="assets/rank-${n}.png" alt="第 ${n} 名"></span>`;
  return `<span class="rank-chip rank-chip-black" aria-label="第 ${n} 名"><span>${n}</span></span>`;
}
